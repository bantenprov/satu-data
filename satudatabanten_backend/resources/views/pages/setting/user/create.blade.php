    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                <h2>Tambah Pengaturan Pengguna <small>Tambah pengaturan pengguna yang anda butuhkan dengan mengisi form di bawah.</small></h2>
            </div>
                ...
                <form id="formValidate" action="{{ route('user.create.save')  }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group fg-float">
                                <div class="fg-line">
                                    <input id="userNIK" class="form-control fg-input" name="userNIK" value="" type="text">
                                </div>
