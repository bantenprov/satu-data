    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body card-padding">
                <form id="formValidate" action="{{ route('access.update.save',base64_encode($role->id)) }}" method="post">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group fg-float">
                                <div class="fg-line">
                                    <input type="text" name="roleName" class="form-control fg-input" value="{{ $role->name }}">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group fg-float">
                                <div class="fg-line">
                                    <textarea name="roleDesc" class="form-control fg-input" rows="3">{{ $role->description }}</textarea>
                                </div>
                                    ...
                                    <tr>
                                        <td style="@if($menu->menu_level == '2') {{ 'padding-left:50px;' }} @endif">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input type="checkbox" name="all[]" class="all child{{ $menu->menu_parent_id }}" id="all_{{ $menu->menu_id }}" data-parent="{{ $menu->menu_parent_id }}" value="{{ $menu->menu_id }}" {{ $checkedRead }}>
                                        ...
                                        <td>
                                            <div class="checkbox">
                                                ...
                                                <label>
                                                    <input type="checkbox" name="permission[]" class="child{{ $menu->menu_parent_id }} create{{ $menu->menu_parent_id }} ck{{ $menu->menu_id }} cekbox" data-type="create" id="create_{{ $menu->menu_id }}" data-parent="{{ $menu->menu_parent_id }}" value="{{ $menu->can_create_id }}" {{ $checkedCreate }}>
                                                    <i class="input-helper"></i>
                                                    {{ $menu->can_create }}
                                                </label>
                                                <?php }else{ ?>
                                        ...
                                        <td>
                                            <div class="checkbox">
                                                ...
                                                <label>
                                                    <input type="checkbox" name="permission[]" class="child{{ $menu->menu_parent_id }} read{{ $menu->menu_parent_id }} ck{{ $menu->menu_id }} cekbox" data-type="read" id="read_{{ $menu->menu_id }}" data-parent="{{ $menu->menu_parent_id }}" value="{{ $menu->can_read_id }}" {{ $checkedRead }}>
                                                    <i class="input-helper"></i>
                                                    {{ $menu->can_read }}
                                                </label>
                                                <?php }else{ ?>
                                        ...
                                        <td>
                                            <div class="checkbox">
                                                ...
                                                <label>
                                                    <input type="checkbox" name="permission[]" class="child{{ $menu->menu_parent_id }} update{{ $menu->menu_parent_id }} ck{{ $menu->menu_id }} cekbox" data-type="update" id="update_{{ $menu->menu_id }}" data-parent="{{ $menu->menu_parent_id }}" value="{{ $menu->can_update_id }}" {{ $checkedUpdate }}>
                                                    <i class="input-helper"></i>
                                                    {{ $menu->can_update }}
                                                </label>
                                                <?php }else{ ?>
                                        ...
                                        <td>
                                            <div class="checkbox">
                                                ...
                                                <label>
                                                    <input type="checkbox" name="permission[]" class="child{{ $menu->menu_parent_id }} delete{{ $menu->menu_parent_id }} ck{{ $menu->menu_id }} cekbox" data-type="delete" id="delete_{{ $menu->menu_id }}" data-parent="{{ $menu->menu_parent_id }}" value="{{ $menu->can_delete_id }}" {{ $checkedDelete }}>
                                                    <i class="input-helper"></i>
                                                    {{ $menu->can_delete }}
                                                </label>
                                                <?php }else{ ?>
