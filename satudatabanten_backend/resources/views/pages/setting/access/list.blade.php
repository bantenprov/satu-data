    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                <h2>Daftar Akses <small>Daftar akses yang telah dibuat.</small></h2>
            </div>
                ...
                <div class="table-responsive">
                    <table id="table1" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th class="text-left" width="25%">Nama</th>
                            <th class="text-left" width="15%">Total Izin</th>
        ...
        $(document).ready(function() {
            var tbl = $('#table1').DataTable({
                ...
                columns: [
                    ...
                    { data: 'total_permissions', name: 'total_permissions', className: 'text-center' },
