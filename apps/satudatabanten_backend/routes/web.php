...
Route::group(['prefix' => 'master','middleware' => 'auth'],function(){
    /* Master ------------------------------------------------------------------------------------------------------------- */
    /* Organizations -------------------------------------------------------------------------------------------------- */
    Route::get('/organizations', ['as'=>'organization','uses'=>'Organization\OrganizationController@getIndex','middleware'=>'permission:read-organizations']);
    Route::get('/organizations/detail/{id}', ['as'=>'organization.detail','uses'=>'Organization\OrganizationController@detailOrganization','middleware'=>'permission:read-organizations']);
    Route::get('/organizations/create', ['as'=>'organization.create','uses'=>'Organization\OrganizationController@createOrganization','middleware'=>'permission:create-organizations']);
    Route::post('/organizations/create', ['as'=>'organization.create.save','uses'=>'Organization\OrganizationController@getIndex','middleware'=>'permission:create-organizations']);
    Route::get('/organizations/update/{id}', ['as'=>'organization.update','uses'=>'Organization\OrganizationController@updateOrganization','middleware'=>'permission:update-organizations']);
    Route::post('/organizations/update/{id}', ['as'=>'organization.update.save','uses'=>'Organization\OrganizationController@getIndex','middleware'=>'permission:update-organizations']);
    Route::post('/organizations/activate/{id}', ['as'=>'organization.activate','uses'=>'Organization\OrganizationController@getIndex','middleware'=>'permission:update-organizations']);
    Route::post('/organizations/unactivate/{id}', ['as'=>'organization.unactivate','uses'=>'Organization\OrganizationController@getIndex','middleware'=>'permission:delete-organizations']);
    /* Groups -------------------------------------------------------------------------------------------------- */
...
Route::group(['prefix' => 'setting','middleware' => 'auth'],function(){
    ...
    Route::get('/applications/detail/{id}',['as'=>'application.detail','uses'=>'Setting\ApplicationController@detailAccess','middleware'=>'permission:read-applications']);
    /* CREATE -------------------------------------------------------------------------------------------------- */
    Route::get('/applications/create',['as'=>'application.create','uses'=>'Setting\ApplicationController@createAccess','middleware'=>'permission:create-applications']);
    Route::post('/applications/create',['as'=>'application.create.save','uses'=>'Setting\ApplicationController@createAccessSave','middleware'=>'permission:create-applications']);
    /* UPDATE -------------------------------------------------------------------------------------------------- */
    Route::get('/applications/update/{id}',['as'=>'application.update','uses'=>'Setting\ApplicationController@updateAccess','middleware'=>'permission:update-applications']);
    Route::post('/applications/update/{id}',['as'=>'application.update.save','uses'=>'Setting\ApplicationController@updateAccessSave','middleware'=>'permission:update-applications']);
    /* DELETE -------------------------------------------------------------------------------------------------- */
    Route::get('/applications/activate/{id}',['as'=>'application.activate','uses'=>'Setting\ApplicationController@activateAccess','middleware'=>'permission:update-applications']);
    Route::get('/applications/unactivate/{id}',['as'=>'application.unactivate','uses'=>'Setting\ApplicationController@unactivateAccess','middleware'=>'permission:delete-applications']);
    # ------------------------------------------------------------------------------------------------------------------------------------
    /* Permissions ----------------------------------------------------------------------------------------------------- */
    /* READ ---------------------------------------------------------------------------------------------------- */
    ...
    Route::post('/users/create',['as'=>'user.create.save','uses'=>'Setting\UserController@createUser','middleware'=>'permission:create-users']);
