                ...
                <div class="col-md-12">
                    <div class="widget widget_search">
                        ...
                        <form class="search-form">
                            <input type="search" class="search-field" placeholder="Cari Data, Tema dan Organisasi  …">
                    ...
                    <div class="iconbox style_1 mag-top">
                        <div class="box-header">
                            <div class="box-icon">
                                ...
                                <img src="{{ asset('assets/images/icon/Pangan.png') }}" alt="">
                            </div>
                            <br>
                    ...
                    <div class="iconbox style_1 mag-top">
                        <div class="box-header">
                            <div class="box-icon">
                                ...
                                <img src="{{ asset('assets/images/icon/Energi.png') }}" alt="">
                            </div>
                            <br>
                    ...
                    <div class="iconbox style_1 mag-top">
                        <div class="box-header">
                            <div class="box-icon">
                                ...
                                <img src="{{ asset('assets/images/icon/Infrastruktur.png') }}" alt="">
                            </div>
                            <br>
                ...
                <div class="col-md-2">
                    <div class="iconbox style_1 mag-top">
                        <div class="box-header">
                            <div class="box-icon">
                                {{--<i class="fa icons icon-calculator"></i>--}}
                                <img src="{{ asset('assets/images/icon/Maritim.png') }}" alt="">
                            </div>
                            <br>
                ...
                <div class="col-md-2">
                    <div class="iconbox style_1 mag-top">
                        <div class="box-header">
                            <div class="box-icon">
                                {{--<i class="fa icons icon-calculator"></i>--}}
                                <img src="{{ asset('assets/images/icon/Kesehatan.png') }}" alt="">
                            </div>
                            <br>
                ...
                <div class="col-md-2">
                    <div class="iconbox style_1 mag-top">
                        <div class="box-header">
                            <div class="box-icon">
                                {{--<i class="fa icons icon-calculator"></i>--}}
                                <img src="{{ asset('assets/images/icon/Pendidikan.png') }}" alt="">
                            </div>
                            <br>
                ...
                <div class="col-md-2">
                    <div class="iconbox style_1 mag-top">
                        <div class="box-header">
                            <div class="box-icon">
                                {{--<i class="fa icons icon-layers"></i>--}}
                                <img src="{{ asset('assets/images/icon/Ekonomi.png') }}" alt="">
                            </div>
                            <br>
                ...
                <div class="col-md-2">
                    <div class="iconbox style_1 mag-top">
                        <div class="box-header">
                            <div class="box-icon">
                                {{--<i class="fa icons icon-chart"></i>--}}
                                <img src="{{ asset('assets/images/icon/Industri.png') }}" alt="">
                            </div>
                            <br>
                ...
                <div class="col-md-2">
                    <div class="iconbox style_1 mag-top">
                        <div class="box-header">
                            <div class="box-icon">
                                {{--<i class="fa icons icon-calculator"></i>--}}
                                <img src="{{ asset('assets/images/icon/Pariwisata.png') }}" alt="">
                            </div>
                            <br>
                ...
                <div class="col-md-2">
                    <div class="iconbox style_1 mag-top">
                        <div class="box-header">
                            <div class="box-icon">
                                {{--<i class="fa icons icon-calculator"></i>--}}
                                <img src="{{ asset('assets/images/icon/Reformasi Birokrasi.png') }}" alt="">
                            </div>
                            <br>
